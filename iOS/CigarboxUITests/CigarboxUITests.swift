...
final class CigarboxUITests: XCTestCase {
    ...
    func testAddFlow() {
        ...
        nameField.tap()
        nameField.typeText("UI Test Cigar")
        app.buttons["saveButton"].tap()
        XCTAssertTrue(app.staticTexts["UI Test Cigar"].waitForExistence(timeout: 2))
    }
